...
- The worker-node tool-call path is unblocked after setting node-local `OUTLINES_CACHE_DIR`; the remaining near-term work is runner hardening and review/apply reliability, not multi-worker dispatch.
